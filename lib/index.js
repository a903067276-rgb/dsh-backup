...
const NS = settingsNamespace('backup')
...
export function apply(ctx, config) {
  ...
  ctx.inject(['settings'], (settingsCtx) => {
    settingsCtx.settings.register(
      NS,
      z.object({
        backupDir: z.string().required(false),
        customDirs: z.array(z.string()).required(false),
        intervalHours: z.number().required(false),
        keepCount: z.number().required(false),
