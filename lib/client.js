window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    if (typeof document !== "undefined" && !document.getElementById("dsh-backup-style")) {
      ...
      tag.textContent = [
        ".bk-card{background:var(--dsw-specific-sidebar-fill,#fff);border:1px solid var(--dsw-alias-border-l1,#e5e5e5);border-radius:10px;padding:12px;color:var(--dsw-alias-label-primary,#333);font-size:13px;line-height:1.6;max-width:560px;}",
    ...
    function BackupSettingsPage() {
      ...
      return react.createElement("div", { className: "bk-card" },
        ...
        react.createElement("div", { className: "field" },
          react.createElement("label", null, "保留份数"),
          react.createElement("input", {
            type: "number",
            min: "1",
            max: "100",
